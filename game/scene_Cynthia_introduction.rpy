...
Narrator "“AMBROSIA COFFEE” stands on the other side of the street."
Narrator "A little trolley of birch wood, red and white wheels and neon pink cursive writing flashes it's name brightly into my vision."
...
Narrator "Whether the man himself works for Cupid or was just magically influenced to move his stand around town so I’d run into it, is guesswork."
...
Narrator "I can walk past it, make my way to work and forget this ever happened-"
Narrator "...But for some reason, I feel like that stand will follow me around tonight. And I cannot be bothered to forget and then be reminded of this bet, every time I see a neon pink light in the corner of my eye."
...
Narrator "This street is a lot emptier than the main street earlier, and the calmer, collected atmosphere harmonizes with the time of day."
Narrator "Dawn will set in soon, the last rays of sunlight shrowding the street into an inviting, comforting warmth."
Narrator "The fairy lights of little bookstores lull me into a trance."
Narrator "The soft petals of white and peach-pink roses in pots, planters and windowsills lining the walls release a sweet and floral scent as I pass them by."
Narrator "The pure sweetness of this moment charms me."
Narrator "I walk up to the stand and have to wait in line behind a few people, giving me time to start fishing for my wallet in my purse."
Narrator "..."
...
Narrator "..."
Narrator "I can feel the stares of everyone behind me, the patience of everyone straining, closing in like a cord in tension about to snap."
...
mystery_cynthia "Excuse the long wait sir, I was beside myself. That’ll be her order aswell as an Oat Milk Latte, please."

Narrator "I turn around to seek the origin of these words."
Narrator "A gorgeous woman in what seems to be a business get-up with immense personal flare stands behind be, her hands resting on her hip."
Narrator "The vendor still doesn’t seem amused by this situation, but he refreshes his customer-service-smile."
Narrator "He gets ready to make the order whilst making small talk with the kind- or just impatient yet fashionable stranger, who has now come up beside me."
...
Narrator "…I was too focused to notice her order being finished up."
...
Narrator "At least she won’t know the difference, she’s only seen me this way which is… embarrassing, but at least she could assume I’m just sunburned instead of coming down with an extreme case of gay panic."

show i_cynthia mischievous

Narrator "Whilst my thoughts are running wild, she smiles gently."
Narrator "...Less toward me and more in conversation with the vendor."
...
Narrator "She takes my arm firmly but not with aggression or too much pressure."
Narrator "It's just enough to be assertive and take me out of the cue with her."
Narrator "She steers me toward a protruding ledge at the base of the romantic little bookstore's shop window."
Narrator "White, wooden arches frame pink tainted glass, dark green vines with small yellow flowers wrap gently along the shop's brick walls, fluttering gently in the summer evening's breeze."
...
Narrator "I have to stop myself from laughing ecstatically when my voice is clear and not as croaky as I’d feared."

show i_cynthia neutral

Me "Sorry yea, I’m a bit all over the place- My name is- Leyla."

Narrator "Cynthia. Her name fits her so well, I ponder."
Narrator "She feels soft, fresh and floral, yet sharp and demanding of your attention, cutting through all else- like the scent of a Hyacynthe."
Narrator "Elegant, sharp, and… Oh she’s begun to lean toward me, her face getting closer and closer than my blood pressure can probably handle."
...
Narrator "How her fingertips aren’t seared off by the scolding heat probably being emitted from my skin, eludes me."

cynthia "Hmm..."

Narrator "She holds my head in place, not that I'd dare to move."
Narrator "Her brown eyes pierce trough me, I feel like I am being assesed, watched, a primal instinct of fear mixed with excitement bubbelign up within me"
Narrator "I let out an almost inaudible squak as she leans my head slighly to the side suddenly, her breath warm and sweet on my skin."

cynthia "So, she’s pretty and she speaks…"

Narrator "I lose my cool entirely and take a shaky breath as she softly glides her thumb from my cheek, then over my chin and back again, letting her touch linger as it passes over the side of my lower lip."

show i_cynthia blushing

cynthia "…what can’t she do?"

Narrator "Luckily, before I die, she pulls away again, focusing her eyes almost in disinterest on the cars passing by, drinking from her coffee at a steady pace."
...
Me "Apparently not. So, what are you then, going around buying people coffee? A millionaire, a helpless flirt, or perhaps a selfless martyr?"
...
Narrator "Cynthia watched me intently, by the looks of her she can tell I'm like a foal confidently running across the stable not really having learned how to- run yet."
Narrator "But for now the Foal is stumbeling and she is curious to see where it will go next, I imagine."

cynthia "A bit of all of the above perhaps?"
cynthia "Not quite a millionaire, yet, but I run my own publishing company so- perhaps enough to qualify in your eyes, I hope."
cynthia "But as it comes to your coffee-"
cynthia "Everyone likes to refer to themselves as selfless, but I’ll admit, I acted very much in my own interest here."
cynthia "As it comes to the “helpless flirt” alligation-" 
cynthia "I mean, it seems to be working out well for me so far, wouldn’t you agree?"
...
Narrator "And hell, this might all be Cupid acting up so, what’s the damage in enjoying this a bit?"
Narrator "Plus, at this point I might aswell get used to it, if this turns out to be a common occurrence tonight…"
Narrator "I’ve had enough of being too nervous to speak, I’ll try and lean into her game."
...
Narrator "I love how the shade of deep red creeps slowly onto her cheeks, she must feel the warmth of it too, lowering her face a bit behind her cup."
...
Narrator "She tucks the hair neatly behind my ear, her nail always running barely over my skin in a way that makes shivers run up my spine."
Narrator "She takes her hand back slowly, finally giving me enough space to let me take a freeing breath."

show i_cynthia blushing

cynthia "You’re not what I expected you to be."
cynthia "You’re oh so much better."
...
Narrator "I am suddenly hit with the realization, that the heat in question is higher than comfortable, and has been slowly increasing in this entire time, my skin staying bare on the scolding cup…"
Narrator "I quickly pass the cup on to my other hand, the slightly scloded skin of the other sharply recovering from it's burn."
...
if _return == opponent:
    ...
    Narrator "She is looking at me with soft fondness as I laugh and stumble through my answer."
    Narrator "Her smile isn’t wide, but her face shines like moonlight- soft, cool, and serene beauty."
    Narrator "It is just for a moment."
    Narrator "But I see it and it makes my heart well up with a deep, appreciative joy."

    show i_cynthia neutral

    Narrator "She lets out a regretful sigh as she stands up, seemingly pulled by unseen forces against her own will."
    ...
    Narrator "It seems like the hand of someone who trained to have beautiful writing, but mostly types in their day-to-day life- the cleanliness having deteriorated a bit over time."
    ...
    Narrator "But what if it isn’t real. If she only did that because of cupid's stupid magic?"
    ...
    Narrator "This was fun, exciting, and felt… good."
    Narrator "But what if it isn’t real? If she only did that because of some magic spell cast upon her?"
    Narrator "Can I allow myself to trust any feelings I have tonight?"
    Narrator "...Ugh."
    Narrator "With this incredibly positive thought on the forefront of my mind, I make my way toward my shift."
